...
private $pgconn;
    ...
    public function ActualizarDatos($nombre, $apellido, $sexo, $edad, $discapacidad, $covidvacuna, $niveleducativo, $ocupacion, $pension, $calle, $nacimiento, $correo, $estadocivil, $telefono, $pgconn) {
        $query = "UPDATE valmapa.habitantesdatos SET nombre='$nombre', apellido='$apellido', sexo='$sexo', edad='$edad', discapacidad='$discapacidad', covidvacuna='$covidvacuna', niveleducativo='$niveleducativo', ocupacion='$ocupacion', pension='$pension', calle='$calle', nacimiento='$nacimiento', correo='$correo', estadocivil='$estadocivil', telefono='$telefono'";
        $rec = pg_query($pgconn, $query) or die;
        return $rec;    
        if ($rec) {
