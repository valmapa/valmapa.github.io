...
<div class="container">
    <header>
        <h1>Formulario de Censo Comunitario VALMAPA</h1>
    </header>
    <main>
        <form action="../../../Controlador/con_nuevocenso.php" method="post">
        ...
        <div class="button-container">
            <button type="button" onclick="window.location.href='index2.php'">Regresar a Inicio</button>
        </div>
    </main>
</html>
<?php
